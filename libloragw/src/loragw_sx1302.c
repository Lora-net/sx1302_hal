...
int sx1302_lora_modem_configure() {
    ...
    lgw_reg_w(SX1302_REG_RX_TOP_FINE_TIMING5_GAIN_I_EN_SF9, 0);
    lgw_reg_w(SX1302_REG_RX_TOP_FINE_TIMING5_GAIN_I_EN_SF10, 0);
    lgw_reg_w(SX1302_REG_RX_TOP_FINE_TIMING5_GAIN_I_EN_SF11, 0);
    lgw_reg_w(SX1302_REG_RX_TOP_FINE_TIMING5_GAIN_I_EN_SF12, 0);
