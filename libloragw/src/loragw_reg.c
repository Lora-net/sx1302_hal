...
const struct lgw_reg_s loregs[LGW_TOTALREGS+1] = {
    ...
    {0,SX1302_REG_COMMON_BASE_ADDR+5,0,0,8,1,0}, // COMMON_VERSION_VERSION
    ...
    {0,SX1302_REG_TX_TOP_A_BASE_ADDR+37,4,0,2,0,0}, // TX_TOP_A_TXRX_CFG0_2_CADRXTX
    ...
    {0,SX1302_REG_TX_TOP_A_BASE_ADDR+48,0,0,5,0,2}, // TX_TOP_A_FRAME_SYNCH_0_PEAK1_POS
    ...
    {0,SX1302_REG_TX_TOP_A_BASE_ADDR+49,0,0,5,0,4}, // TX_TOP_A_FRAME_SYNCH_1_PEAK2_POS
    ...
    {0,SX1302_REG_TX_TOP_B_BASE_ADDR+37,4,0,2,0,0}, // TX_TOP_B_TXRX_CFG0_2_CADRXTX
    ...
    {0,SX1302_REG_TX_TOP_B_BASE_ADDR+48,0,0,5,0,2}, // TX_TOP_B_FRAME_SYNCH_0_PEAK1_POS
    ...
    {0,SX1302_REG_TX_TOP_B_BASE_ADDR+49,0,0,5,0,4}, // TX_TOP_B_FRAME_SYNCH_1_PEAK2_POS
    {0,0,0,0,0,0,0}
};
