...
const struct lgw_reg_s loregs[LGW_TOTALREGS+1] = {
    ...
    {0,SX1302_REG_RX_TOP_BASE_ADDR+148,0,0,2,0,1,0}, // RX_TOP_FINE_TIMING_A_3_GAIN_I_AUTO_MAX
    ...
    {0,SX1302_REG_RX_TOP_BASE_ADDR+152,7,0,1,0,1,1}, // RX_TOP_FINE_TIMING_B_0_GAIN_P_HDR_RED
    {0,SX1302_REG_RX_TOP_BASE_ADDR+152,6,0,1,0,1,0}, // RX_TOP_FINE_TIMING_B_0_ROUNDING
    {0,SX1302_REG_RX_TOP_BASE_ADDR+152,4,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_0_POS_LIMIT
    {0,SX1302_REG_RX_TOP_BASE_ADDR+152,2,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_0_SUM_SIZE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+152,0,0,2,0,1,3}, // RX_TOP_FINE_TIMING_B_0_MODE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+153,6,0,2,0,1,1}, // RX_TOP_FINE_TIMING_B_1_GAIN_P_AUTO
    {0,SX1302_REG_RX_TOP_BASE_ADDR+153,3,0,3,0,1,2}, // RX_TOP_FINE_TIMING_B_1_GAIN_P_PAYLOAD
    {0,SX1302_REG_RX_TOP_BASE_ADDR+153,0,0,3,0,1,6}, // RX_TOP_FINE_TIMING_B_1_GAIN_P_PREAMB
    {0,SX1302_REG_RX_TOP_BASE_ADDR+154,6,0,2,0,1,3}, // RX_TOP_FINE_TIMING_B_2_GAIN_I_AUTO
    {0,SX1302_REG_RX_TOP_BASE_ADDR+154,3,0,3,0,1,1}, // RX_TOP_FINE_TIMING_B_2_GAIN_I_PAYLOAD
    {0,SX1302_REG_RX_TOP_BASE_ADDR+154,0,0,3,0,1,4}, // RX_TOP_FINE_TIMING_B_2_GAIN_I_PREAMB
    {0,SX1302_REG_RX_TOP_BASE_ADDR+155,7,0,1,0,1,0}, // RX_TOP_FINE_TIMING_B_3_FINESYNCH_SUM
    {0,SX1302_REG_RX_TOP_BASE_ADDR+155,4,0,3,0,1,5}, // RX_TOP_FINE_TIMING_B_3_FINESYNCH_GAIN
    {0,SX1302_REG_RX_TOP_BASE_ADDR+155,0,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_3_GAIN_I_AUTO_MAX
    {0,SX1302_REG_RX_TOP_BASE_ADDR+156,6,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_4_GAIN_I_EN_SF8
    {0,SX1302_REG_RX_TOP_BASE_ADDR+156,4,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_4_GAIN_I_EN_SF7
    {0,SX1302_REG_RX_TOP_BASE_ADDR+156,2,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_4_GAIN_I_EN_SF6
    {0,SX1302_REG_RX_TOP_BASE_ADDR+156,0,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_4_GAIN_I_EN_SF5
    {0,SX1302_REG_RX_TOP_BASE_ADDR+157,6,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_5_GAIN_I_EN_SF12
    {0,SX1302_REG_RX_TOP_BASE_ADDR+157,4,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_5_GAIN_I_EN_SF11
    {0,SX1302_REG_RX_TOP_BASE_ADDR+157,2,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_5_GAIN_I_EN_SF10
    {0,SX1302_REG_RX_TOP_BASE_ADDR+157,0,0,2,0,1,0}, // RX_TOP_FINE_TIMING_B_5_GAIN_I_EN_SF9
    {0,SX1302_REG_RX_TOP_BASE_ADDR+158,4,0,3,0,1,7}, // RX_TOP_FINE_TIMING_B_6_GAIN_P_PREAMB_SF12
    {0,SX1302_REG_RX_TOP_BASE_ADDR+158,0,0,3,0,1,4}, // RX_TOP_FINE_TIMING_B_6_GAIN_P_PREAMB_SF5_6
    {0,SX1302_REG_RX_TOP_BASE_ADDR+159,0,0,4,0,1,9}, // RX_TOP_FREQ_TO_TIME0_FREQ_TO_TIME_DRIFT_MANT
    {0,SX1302_REG_RX_TOP_BASE_ADDR+160,0,0,8,0,1,112}, // RX_TOP_FREQ_TO_TIME1_FREQ_TO_TIME_DRIFT_MANT
    {0,SX1302_REG_RX_TOP_BASE_ADDR+161,0,0,3,0,1,3}, // RX_TOP_FREQ_TO_TIME2_FREQ_TO_TIME_DRIFT_EXP
    {0,SX1302_REG_RX_TOP_BASE_ADDR+162,5,0,1,0,1,0}, // RX_TOP_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_FREQ_DELTA
    {0,SX1302_REG_RX_TOP_BASE_ADDR+162,4,0,1,0,1,0}, // RX_TOP_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_FINE_DELTA
    {0,SX1302_REG_RX_TOP_BASE_ADDR+162,3,0,1,0,1,1}, // RX_TOP_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_FREQ_ERROR
    {0,SX1302_REG_RX_TOP_BASE_ADDR+162,2,0,1,0,1,0}, // RX_TOP_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_TIME_SYMB
    {0,SX1302_REG_RX_TOP_BASE_ADDR+162,1,0,1,0,1,0}, // RX_TOP_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_TIME_OFFSET
    {0,SX1302_REG_RX_TOP_BASE_ADDR+162,0,0,1,0,1,1}, // RX_TOP_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_DETECT
    {0,SX1302_REG_RX_TOP_BASE_ADDR+163,0,0,8,0,1,33}, // RX_TOP_FREQ_TO_TIME4_FREQ_TO_TIME_INVERT_RNG
    {0,SX1302_REG_RX_TOP_BASE_ADDR+164,6,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_A_0_FREQ_TRACK_EN_SF8
    {0,SX1302_REG_RX_TOP_BASE_ADDR+164,4,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_A_0_FREQ_TRACK_EN_SF7
    {0,SX1302_REG_RX_TOP_BASE_ADDR+164,2,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_A_0_FREQ_TRACK_EN_SF6
    {0,SX1302_REG_RX_TOP_BASE_ADDR+164,0,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_A_0_FREQ_TRACK_EN_SF5
    {0,SX1302_REG_RX_TOP_BASE_ADDR+165,6,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_A_1_FREQ_TRACK_EN_SF12
    {0,SX1302_REG_RX_TOP_BASE_ADDR+165,4,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_A_1_FREQ_TRACK_EN_SF11
    {0,SX1302_REG_RX_TOP_BASE_ADDR+165,2,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_A_1_FREQ_TRACK_EN_SF10
    {0,SX1302_REG_RX_TOP_BASE_ADDR+165,0,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_A_1_FREQ_TRACK_EN_SF9
    {0,SX1302_REG_RX_TOP_BASE_ADDR+166,6,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_B_0_FREQ_TRACK_EN_SF8
    {0,SX1302_REG_RX_TOP_BASE_ADDR+166,4,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_B_0_FREQ_TRACK_EN_SF7
    {0,SX1302_REG_RX_TOP_BASE_ADDR+166,2,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_B_0_FREQ_TRACK_EN_SF6
    {0,SX1302_REG_RX_TOP_BASE_ADDR+166,0,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_B_0_FREQ_TRACK_EN_SF5
    {0,SX1302_REG_RX_TOP_BASE_ADDR+167,6,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_B_1_FREQ_TRACK_EN_SF12
    {0,SX1302_REG_RX_TOP_BASE_ADDR+167,4,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_B_1_FREQ_TRACK_EN_SF11
    {0,SX1302_REG_RX_TOP_BASE_ADDR+167,2,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_B_1_FREQ_TRACK_EN_SF10
    {0,SX1302_REG_RX_TOP_BASE_ADDR+167,0,0,2,0,1,3}, // RX_TOP_FREQ_TRACK_B_1_FREQ_TRACK_EN_SF9
    {0,SX1302_REG_RX_TOP_BASE_ADDR+168,7,0,1,0,1,0}, // RX_TOP_FREQ_TRACK2_FREQ_TRACK_FINE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+168,4,0,3,0,1,4}, // RX_TOP_FREQ_TRACK2_FREQ_TRACK_HDR_SKIP
    {0,SX1302_REG_RX_TOP_BASE_ADDR+169,4,0,3,0,1,5}, // RX_TOP_FREQ_TRACK3_FREQ_SYNCH_GAIN
    {0,SX1302_REG_RX_TOP_BASE_ADDR+169,0,0,4,0,1,3}, // RX_TOP_FREQ_TRACK3_FREQ_TRACK_AUTO_THR
    {0,SX1302_REG_RX_TOP_BASE_ADDR+170,5,0,2,0,1,1}, // RX_TOP_FREQ_TRACK4_SNR_MIN_WINDOW
    {0,SX1302_REG_RX_TOP_BASE_ADDR+170,4,0,1,0,1,0}, // RX_TOP_FREQ_TRACK4_GAIN_AUTO_SNR_MIN
    {0,SX1302_REG_RX_TOP_BASE_ADDR+170,0,0,4,0,1,8}, // RX_TOP_FREQ_TRACK4_FREQ_SYNCH_THR
    {0,SX1302_REG_RX_TOP_BASE_ADDR+171,0,0,7,0,1,32}, // RX_TOP_DETECT_MSP0_MSP_PNR
    {0,SX1302_REG_RX_TOP_BASE_ADDR+172,0,0,7,0,1,48}, // RX_TOP_DETECT_MSP1_MSP2_PNR
    {0,SX1302_REG_RX_TOP_BASE_ADDR+173,4,0,3,0,1,5}, // RX_TOP_DETECT_MSP2_MSP2_PEAK_NB
    {0,SX1302_REG_RX_TOP_BASE_ADDR+173,0,0,3,0,1,3}, // RX_TOP_DETECT_MSP2_MSP_PEAK_NB
    {0,SX1302_REG_RX_TOP_BASE_ADDR+174,6,0,1,0,1,0}, // RX_TOP_DETECT_MSP3_ACC_MIN2
    {0,SX1302_REG_RX_TOP_BASE_ADDR+174,4,0,2,0,1,2}, // RX_TOP_DETECT_MSP3_ACC_WIN_LEN
    {0,SX1302_REG_RX_TOP_BASE_ADDR+174,2,0,1,0,1,1}, // RX_TOP_DETECT_MSP3_MSP_POS_SEL
    {0,SX1302_REG_RX_TOP_BASE_ADDR+174,0,0,2,0,1,1}, // RX_TOP_DETECT_MSP3_MSP_CNT_MODE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+175,7,0,1,0,1,0}, // RX_TOP_DETECT_ACC1_USE_GAIN_SYMB
    {0,SX1302_REG_RX_TOP_BASE_ADDR+175,0,0,7,0,1,64}, // RX_TOP_DETECT_ACC1_ACC_PNR
    {0,SX1302_REG_RX_TOP_BASE_ADDR+176,6,0,2,0,1,2}, // RX_TOP_DETECT_ACC2_NOISE_COEFF
    {0,SX1302_REG_RX_TOP_BASE_ADDR+176,4,0,2,0,1,2}, // RX_TOP_DETECT_ACC2_ACC_COEFF
    {0,SX1302_REG_RX_TOP_BASE_ADDR+176,3,0,1,0,1,1}, // RX_TOP_DETECT_ACC2_ACC_2_SAME_PEAKS
    {0,SX1302_REG_RX_TOP_BASE_ADDR+176,2,0,1,0,1,1}, // RX_TOP_DETECT_ACC2_ACC_AUTO_RESCALE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+176,1,0,1,0,1,1}, // RX_TOP_DETECT_ACC2_ACC_PEAK_POS_SEL
    {0,SX1302_REG_RX_TOP_BASE_ADDR+176,0,0,1,0,1,1}, // RX_TOP_DETECT_ACC2_ACC_PEAK_SUM_EN
    {0,SX1302_REG_RX_TOP_BASE_ADDR+177,0,0,8,0,1,11}, // RX_TOP_DETECT_ACC3_MIN_SINGLE_PEAK
    {0,SX1302_REG_RX_TOP_BASE_ADDR+178,4,0,1,0,1,0}, // RX_TOP_TIMESTAMP_SEL_SNR_MIN
    {0,SX1302_REG_RX_TOP_BASE_ADDR+178,3,0,1,0,1,0}, // RX_TOP_TIMESTAMP_ENABLE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+178,0,0,3,0,1,7}, // RX_TOP_TIMESTAMP_NB_SYMB
    {0,SX1302_REG_RX_TOP_BASE_ADDR+179,0,0,8,1,1,0}, // RX_TOP_MODEM_BUSY_MSB_RX_MODEM_BUSY
    {0,SX1302_REG_RX_TOP_BASE_ADDR+180,0,0,8,1,1,0}, // RX_TOP_MODEM_BUSY_LSB_RX_MODEM_BUSY
    {0,SX1302_REG_RX_TOP_BASE_ADDR+181,4,0,4,1,1,0}, // RX_TOP_MODEM_STATE_RX_MODEM_STS_SPARE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+181,0,0,4,1,1,0}, // RX_TOP_MODEM_STATE_RX_MODEM_STATE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+182,6,0,2,0,1,2}, // RX_TOP_MODEM_SYNC_DELTA_MSB_PEAK_POS_FINE_GAIN_H
    {0,SX1302_REG_RX_TOP_BASE_ADDR+182,4,0,2,0,1,3}, // RX_TOP_MODEM_SYNC_DELTA_MSB_PEAK_POS_FINE_GAIN_L
    {0,SX1302_REG_RX_TOP_BASE_ADDR+182,3,0,1,0,1,1}, // RX_TOP_MODEM_SYNC_DELTA_MSB_PEAK_POS_FINE_SIGN
    {0,SX1302_REG_RX_TOP_BASE_ADDR+182,0,0,3,0,1,0}, // RX_TOP_MODEM_SYNC_DELTA_MSB_MODEM_SYNC_DELTA
    {0,SX1302_REG_RX_TOP_BASE_ADDR+183,0,0,8,0,1,127}, // RX_TOP_MODEM_SYNC_DELTA_LSB_MODEM_SYNC_DELTA
    {0,SX1302_REG_RX_TOP_BASE_ADDR+184,6,0,2,0,1,0}, // RX_TOP_MODEM_PPM_OFFSET1_PPM_OFFSET_SF8
    {0,SX1302_REG_RX_TOP_BASE_ADDR+184,4,0,2,0,1,0}, // RX_TOP_MODEM_PPM_OFFSET1_PPM_OFFSET_SF7
    {0,SX1302_REG_RX_TOP_BASE_ADDR+184,2,0,2,0,1,0}, // RX_TOP_MODEM_PPM_OFFSET1_PPM_OFFSET_SF6
    {0,SX1302_REG_RX_TOP_BASE_ADDR+184,0,0,2,0,1,0}, // RX_TOP_MODEM_PPM_OFFSET1_PPM_OFFSET_SF5
    {0,SX1302_REG_RX_TOP_BASE_ADDR+185,6,0,2,0,1,1}, // RX_TOP_MODEM_PPM_OFFSET2_PPM_OFFSET_SF12
    {0,SX1302_REG_RX_TOP_BASE_ADDR+185,4,0,2,0,1,1}, // RX_TOP_MODEM_PPM_OFFSET2_PPM_OFFSET_SF11
    {0,SX1302_REG_RX_TOP_BASE_ADDR+185,2,0,2,0,1,0}, // RX_TOP_MODEM_PPM_OFFSET2_PPM_OFFSET_SF10
    {0,SX1302_REG_RX_TOP_BASE_ADDR+185,0,0,2,0,1,0}, // RX_TOP_MODEM_PPM_OFFSET2_PPM_OFFSET_SF9
    {0,SX1302_REG_RX_TOP_BASE_ADDR+186,0,0,8,0,1,85}, // RX_TOP_MODEM_CLOCK_GATE_OVERRIDE_3_CLK_OVERRIDE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+187,0,0,8,0,1,85}, // RX_TOP_MODEM_CLOCK_GATE_OVERRIDE_2_CLK_OVERRIDE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+188,0,0,8,0,1,85}, // RX_TOP_MODEM_CLOCK_GATE_OVERRIDE_1_CLK_OVERRIDE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+189,0,0,8,0,1,85}, // RX_TOP_MODEM_CLOCK_GATE_OVERRIDE_0_CLK_OVERRIDE
    {0,SX1302_REG_RX_TOP_BASE_ADDR+190,0,0,1,1,1,0}, // RX_TOP_DUMMY2_DUMMY2
    ...
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+52,2,0,2,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_FINE_TIMING3_GAIN_I_AUTO_MAX
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+52,0,0,2,0,1,3}, // RX_TOP_LORA_SERVICE_FSK_FINE_TIMING3_GAIN_I_AUTO
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+53,0,0,4,0,1,9}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME0_FREQ_TO_TIME_DRIFT_MANT
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+54,0,0,8,0,1,112}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME1_FREQ_TO_TIME_DRIFT_MANT
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+55,0,0,3,0,1,3}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME2_FREQ_TO_TIME_DRIFT_EXP
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+56,5,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_FREQ_DELTA
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+56,4,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_FINE_DELTA
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+56,3,0,1,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_FREQ_ERROR
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+56,2,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_TIME_SYMB
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+56,1,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_TIME_OFFSET
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+56,0,0,1,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME3_FREQ_TO_TIME_INVERT_DETECT
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+57,0,0,8,0,1,33}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TO_TIME4_FREQ_TO_TIME_INVERT_RNG
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+58,7,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TRACK0_FREQ_TRACK_FINE
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+58,4,0,3,0,1,4}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TRACK0_FREQ_TRACK_HDR_SKIP
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+58,0,0,2,0,1,3}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TRACK0_FREQ_TRACK_EN
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+59,4,0,3,0,1,5}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TRACK1_FREQ_SYNCH_GAIN
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+59,0,0,4,0,1,3}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TRACK1_FREQ_TRACK_AUTO_THR
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+60,5,0,2,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TRACK2_SNR_MIN_WINDOW
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+60,4,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TRACK2_GAIN_AUTO_SNR_MIN
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+60,0,0,4,0,1,8}, // RX_TOP_LORA_SERVICE_FSK_FREQ_TRACK2_FREQ_SYNCH_THR
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+61,0,0,7,0,1,24}, // RX_TOP_LORA_SERVICE_FSK_DETECT_MSP0_MSP_PNR
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+62,0,0,7,0,1,48}, // RX_TOP_LORA_SERVICE_FSK_DETECT_MSP1_MSP2_PNR
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+63,4,0,3,0,1,7}, // RX_TOP_LORA_SERVICE_FSK_DETECT_MSP2_MSP2_PEAK_NB
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+63,0,0,3,0,1,7}, // RX_TOP_LORA_SERVICE_FSK_DETECT_MSP2_MSP_PEAK_NB
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+64,7,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_DETECT_MSP3_ACC_MIN2
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+64,4,0,2,0,1,2}, // RX_TOP_LORA_SERVICE_FSK_DETECT_MSP3_ACC_WIN_LEN
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+64,2,0,1,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_DETECT_MSP3_MSP_POS_SEL
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+64,0,0,2,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_DETECT_MSP3_MSP_CNT_MODE
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+65,7,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_DETECT_ACC1_USE_GAIN_SYMB
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+65,0,0,7,0,1,55}, // RX_TOP_LORA_SERVICE_FSK_DETECT_ACC1_ACC_PNR
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+66,6,0,2,0,1,2}, // RX_TOP_LORA_SERVICE_FSK_DETECT_ACC2_NOISE_COEFF
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+66,4,0,2,0,1,2}, // RX_TOP_LORA_SERVICE_FSK_DETECT_ACC2_ACC_COEFF
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+66,3,0,1,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_DETECT_ACC2_ACC_2_SAME_PEAKS
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+66,2,0,1,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_DETECT_ACC2_ACC_AUTO_RESCALE
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+66,1,0,1,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_DETECT_ACC2_ACC_PEAK_POS_SEL
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+66,0,0,1,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_DETECT_ACC2_ACC_PEAK_SUM_EN
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+67,0,0,8,0,1,11}, // RX_TOP_LORA_SERVICE_FSK_DETECT_ACC3_MIN_SINGLE_PEAK
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+68,4,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_TIMESTAMP_SEL_SNR_MIN
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+68,3,0,1,0,1,0}, // RX_TOP_LORA_SERVICE_FSK_TIMESTAMP_ENABLE
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+68,0,0,3,0,1,7}, // RX_TOP_LORA_SERVICE_FSK_TIMESTAMP_NB_SYMB
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+69,6,0,2,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_CLOCK_GATE_OVERRIDE_FSK_TRANSPOSE_CLK_OVERRIDE
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+69,4,0,2,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_CLOCK_GATE_OVERRIDE_FSK_MODEM_CLK_OVERRIDE
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+69,2,0,2,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_CLOCK_GATE_OVERRIDE_TRANSPOSE_CLK_OVERRIDE
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+69,0,0,2,0,1,1}, // RX_TOP_LORA_SERVICE_FSK_CLOCK_GATE_OVERRIDE_MODEM_CLK_OVERRIDE
    {0,SX1302_REG_RX_TOP_LORA_SERVICE_FSK_BASE_ADDR+70,0,0,1,1,1,0}, // RX_TOP_LORA_SERVICE_FSK_DUMMY0_DUMMY0
